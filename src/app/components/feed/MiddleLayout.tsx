...
export default function MiddleLayout({ postsData, user }: { postsData: any, user: any }) {
    ...
    const [c_comments, setC_Comments] = useState<{ [key: string]: string }>({});
    ...
    const handleChildCommentChange = (postId: string, value: string) => {
        setC_Comments(prev => ({
            ...prev,
            [postId]: value
        }));
    ...
    const handleImage = async (e: any) => {
        ...
        try {
            const res = await fetch(
                `https://api.imgbb.com/1/upload?key=32d2666d7c019e2a29f06cde6e9c8481`,
                {
                    method: "POST",
                    body: formData,
                }
                    ...
                    <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
                        ...
                        <div className="_feed_inner_text_area_bottom">
                            ...
                            <div className="_feed_inner_text_area_btn">
                                <button form='myForm' type="submit" className="_feed_inner_text_area_btn_link">
                                    <svg
                                        className="_mar_img"
                                        xmlns="http://www.w3.org/2000/svg"
                                        width={14}
                            ...
                            <div key={post.id} className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
                                    ...
                                    <div className="_feed_inner_timeline_post_top">
                                        <div className="_feed_inner_timeline_post_box">
                                            <div className="_feed_inner_timeline_post_box_image">
                                                <Image
                                                    src={post?.user?.image || "/assets/images/avatare.png"}
                                                    width={0}
                                                    height={0}
                                                    alt=''
                                                    className="_post_img"
                                ...
                                <div className="_feed_inner_timeline_cooment_area">
                                    <div className="_feed_inner_comment_box">
                                        ...
                                        <form onSubmit={(e) => handleSubmitComment(e, post.id)} className="_feed_inner_comment_box_form">
...

                                    {
                                        post?.comments.map((comment: any) => (
                                            <div key={comment.id} className="_comment_main"
                                                style={{ marginLeft: comment.parentId ? "60px" : "0px" }}
                                            >
                                                ...
                                                <div className="_comment_area">
                                                    <div className="_comment_details">
                                                        ...
                                                        <div className="_total_reactions">
                                                            ...
                                                            <span className="_total">{comment?._count?.commentReactions}</span>
                                                        </div>
                                                    ...
                                                    <div className="_feed_inner_comment_box">
                                                        <form onSubmit={(e) => handleSubmitComment(e, post.id, comment.id)} className="_feed_inner_comment_box_form">
                                                            <div className="_feed_inner_comment_box_content">
                                                                <div className="_feed_inner_comment_box_content_image">
                                                                    <Image
                                                                        src={user?.image}
                                                                ...
                                                                <div className="_feed_inner_comment_box_content_txt">
                                                                    <textarea
                                                                        ...
                                                                        placeholder="Write a comment"
                                                                        id="floatingTextarea2"
                                                                        value={c_comments[comment.id] || ""}
                                                                        onChange={(e) =>
                                                                            handleChildCommentChange(comment.id, e.target.value)
                                                                        }
                                                                    />
                                                                </div>
                                                            </div>
